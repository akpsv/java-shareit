...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItemRequest(long userId, ItemRequestDtoIn itemRequestDtoIn) {
    ...
    public ResponseEntity<Object> getItemRequestsCreatedAnotherUsers(long userId, Integer from, Integer size) {
